...
$(document).ready(function(){
	...
	$('#mercury-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Mercury');
	...
	$('#venus-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Venus');
	...
	$('#earth-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Earth');
	...
	$('#mars-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Mars');
	...
	$('#jupiter-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Jupiter');
	...
	$('#saturn-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Saturn');
	...
	$('#uranus-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Uranus');
	...
	$('#neptune-orbit #planet').click(function(){
		$('#current-planet').addClass('earth');
		$('.name').html('Neptune');
